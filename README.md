...
**次がいつかも示す** (#214)｡"Sync list…" の隣に "Next sync in 5h 12m"､右端に
タイムラインの "Next refresh in 4m"｡どちらも 1 分を切るまでは分単位で､
ループが動いていないとき (auto-refresh を切った､サインイン前､X に拒まれて
止まった) は出ない｡画面ロック中は "Next refresh: paused" になる｡
