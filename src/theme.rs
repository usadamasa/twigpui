...
/// 添付画像 1 段の高さの上限 (#256)｡縦長の 1 枚はここで止まる｡
///
/// #95 で 160px の 2 列グリッドが添付 4 枚だけでウィンドウを埋め､timeline が
/// timeline でなくなった｡今は複数枚を 1 段に並べるので段の高さは 1 つ分しか
/// 無く､この高さでもウィンドウの 1/3 に届かない｡サムネイルは読むものでは
/// なく､ちゃんと見るためにクリックするもの (#70) だ｡
